...
export default function AttachBar({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <PreTaskToggle chatId={chatId} groupId={groupId} value={preCfg} onApplied={onApplyPreCfg} style={{ padding: '6px 10px', borderRadius: 8, border: '1px solid #2a3346', background: '#202840', color: '#e8eaed' }} />
